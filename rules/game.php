...
<head>
    <meta charset="utf-8">
    <title>Game Rules | Rules Committee Panel | The AuroraMC Network</title>
...
<body style="background-color: #23272A;color:white" onload="loadRules(2)">
    ...
    <div class="row">
        ...
        <div class="col-sm-8 col-xs-12">
            <div id="content" style="display: none;">
                ...
                <button type="button" class="btn btn-success" onclick="newrule(2)" style="margin-left:50%;margin-right:50%;"><i class="fas fa-plus"></i> Create Rule</button>
                <br>
                <br>
                <br>
                <br>
