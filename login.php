        ...
        <div class="card mx-xl-5">
            ...
            <div class="card-body">
                <form action="utils/process-login.php" method="post" name="login_form" id="login_form">
                    ...
                    <button type="button" class="btn btn-default" form="login_form" onclick="formhash(this.form, this.form.username.value, this.form.password.value, this.form.code.value);">Login</button></div></div>
                </form>
            </div>
        </div>
    </div>
