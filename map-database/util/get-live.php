...
if ($sql = $mysqli->prepare("SELECT parse_id,map_id,map_name,map_author,game,build_server_maps.world_name,parse_number,parse_version,last_modified FROM maps INNER JOIN build_server_maps ON maps.map_id=build_server_maps.id WHERE parse_version = 'LIVE'")) {
