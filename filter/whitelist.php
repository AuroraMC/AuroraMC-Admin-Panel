...
<body style="background-color: #23272A;color:white" onload="onLoadWords('whitelist')">
    ...
    <div class="row">
        ...
        <div class="col-sm-8 col-xs-12 ">
            ...
            <div class="container" id="content" style="display: none">
                <div class="row">
                    <h1 style="text-align: center;margin-right: auto;margin-left: auto">Filter Whitelisted Words</h1 >
                </div>
                <div class="row">
                    <div class="col-12">
