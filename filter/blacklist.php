...
<head>
    <meta charset="utf-8">
    <title>Blacklisted Words | Chat Filter Panel | The AuroraMC Network</title>
    ...
    <div class="row">
        ...
        <div class="col-sm-8 col-xs-12 ">
            ...
            <form class="form-inline d-flex justify-content-center md-form form-sm mt-0" id="usersearch">
                ...
                <input class="form-control form-control-sm ml-3 w-75" type="text" placeholder="Add Blacklisted Word"
                       aria-label="Search" name="blacklist" style="color: white;" id="blacklist">
            </form>
            <?php
            include_once "../database/db-connect.php";

                            $results = $redis->sMembers("filter.blacklist");

                            echo '<div class="container">
                                <div class="row">
                                    <h1 style="text-align: center;margin-right: auto;margin-left: auto">Blacklisted Words</h1 >
                                </div>
                                <div class="row">
                                <div class="col-12">
                            ...
                            foreach ($results as $result) {
                                        ...
                                        echo '
                                                   <tr id="', $result, '">
                                                    <td>', $result, '</td>
                                                    <td><button type="button" class="btn btn-danger" onclick="removeWord(\'', $result, '\', \'blacklist\')"><i class="fas fa-trash-alt"></i> Remove</button></td></tr>';
                            }
                            echo '</tbody>
                                        </table>   
                                        </div>
