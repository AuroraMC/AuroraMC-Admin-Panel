...
<head>
    <meta charset="utf-8">
    <title>Core Words | Chat Filter Panel | The AuroraMC Network</title>
    ...
    <div class="navbar-collapse collapse w-100 dual-collapse2 order-2 order-md-2">
        <ul class="navbar-nav mr-auto text-center">
            <li class="nav-item active">
                <a class="nav-link" href="#">Core Words</a>
            </li>
            <li class="nav-item">
    ...
    <div class="row">
        ...
        <div class="col-sm-8 col-xs-12 ">
            ...
            <form class="form-inline d-flex justify-content-center md-form form-sm mt-0" id="usersearch">
                ...
                <input class="form-control form-control-sm ml-3 w-75" type="text" placeholder="Add Core Word"
                       aria-label="Search" name="core" style="color: white;" id="core">
            </form>
            <?php

                            $results = $redis->sMembers("filter.core");

                            echo '<div class="container">
                                <div class="row">
                                    <h1 style="text-align: center;margin-right: auto;margin-left: auto">Core Filter Words</h1 >
                                </div>
                                <div class="row">
                                <div class="col-12">
                            ...
                            foreach ($results as $result) {
                                        ...
                                        echo '
                                                   <tr id="', $result, '">
                                                    <td>', $result, '</td>
                                                    <td><button type="button" class="btn btn-danger" onclick="removeWord(\'', $result, '\', \'core\')"><i class="fas fa-trash-alt"></i> Remove</button></td></tr>';
                            }
                            echo '</tbody>
                                        </table>   
                                        </div>
